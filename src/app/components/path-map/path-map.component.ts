  ...
  private generateMockPath(): LearningPath {
    const mockNodes: PathNode[] = [
      ...
      },
      {
        ...
        difficulty: 4,
        estimated_hours: 10,
        description: '结合传感器与Python实现温度监控',
        status: 'pending',
      },
      {
        node_id: 'n9',
