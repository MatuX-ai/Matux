    ...
    <div class="modal-overlay" (click)="onClose()">
      <div class="modal-container" (click)="$event.stopPropagation()">
        ...
        <div class="modal-header">
          <h2 class="modal-title">登录 MatuX</h2>
          <p class="modal-subtitle">欢迎回来，继续你的AI学习之旅</p>
        </div>
        ...
        <!-- 邮箱登录表单 -->
        <form class="login-form" (ngSubmit)="onLogin()" *ngIf="loginMethod === 'email'">
        ...
        <!-- 手机登录（预留） -->
        <div class="reserved-notice" *ngIf="loginMethod === 'phone'">
        ...
        <div class="social-login">
          ...
          <div class="social-buttons-grid">
            <!-- GitHub - 已支持 -->
            <button class="social-btn github" (click)="loginWithGitHub()" title="GitHub 登录">
            ...
            <!-- 微信 - 预留 -->
            <button class="social-btn wechat disabled" title="微信登录即将上线" disabled>
              <svg class="social-icon" viewBox="0 0 24 24" width="18" height="18">
                <path
                  fill="currentColor"
            ...
            <!-- Google - 预留 -->
            <button class="social-btn google disabled" title="Google 登录即将上线" disabled>
              <svg class="social-icon" viewBox="0 0 24 24" width="18" height="18">
                <path
                  fill="#4285F4"
            ...
            <!-- Facebook - 预留 -->
            <button class="social-btn facebook disabled" title="Facebook 登录即将上线" disabled>
              <svg class="social-icon" viewBox="0 0 24 24" width="18" height="18">
                <path
                  fill="#1877F2"
            ...
            <!-- X (Twitter) - 预留 -->
            <button class="social-btn x disabled" title="X 登录即将上线" disabled>
              <svg class="social-icon" viewBox="0 0 24 24" width="18" height="18">
                <path
                  fill="currentColor"
        ...
        <div class="register-link">
          <span>还没有账号？</span>
          <a (click)="$event.stopPropagation(); onRegisterClick()">立即注册</a>
        </div>
      </div>
    </div>
  `,
