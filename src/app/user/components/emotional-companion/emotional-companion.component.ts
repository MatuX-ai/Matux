...
@Component({
        ...
        <mat-card-content>
          <div class="summary-grid">
            <div class="summary-item">
              <span class="summary-value summary-dominant"
                >{{ summaryEmoji }} {{ summaryLabel }}</span
              >
            ...
            <div class="summary-item">
              <span
                class="summary-value"
                [style.color]="(summary?.positivityRatio ?? 0) >= 0.6 ? '#22c55e' : '#f59e0b'"
              >
            ...
            <div class="summary-item">
              <span
                class="summary-value"
                [style.color]="
                  (summary?.volatility ?? 0) < 0.3
                    ? '#22c55e'
                    : (summary?.volatility ?? 0) < 0.6
                      ? '#f59e0b'
                      : '#ef4444'
                "
              >
        ...
        <mat-card-content>
          <div *ngFor="let entry of recentLogs" class="history-entry">
            ...
            <div class="history-intensity">
              <span *ngFor="let _ of intensityStars(entry.intensity)" class="intensity-star"
                >⭐</span
              >
            </div>
          </div>
  ...
  styles: [
    `
      ...
      .mood-btn.selected {
        background: white;
        border-color: var(--mood-color, #3b82f6);
...
export class EmotionalCompanionComponent implements OnInit, OnDestroy {
  ...
  moodOptions: { emotion: EmotionState; emoji: string; label: string; color: string }[] = [
    ...
    { emotion: 'sad', emoji: '😢', label: '难过', color: '#2563eb' },
