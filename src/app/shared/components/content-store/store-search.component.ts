    ...
    <div class="search-container">
      <div class="search-header">
        ...
        <div class="filter-chips">
          <mat-chip-listbox>
            <mat-chip-option [selected]="selectedType === 'all'" (click)="filterByType('all')"
              >全部</mat-chip-option
            >
            <mat-chip-option [selected]="selectedType === 'course'" (click)="filterByType('course')"
              >课程</mat-chip-option
            >
            <mat-chip-option
              [selected]="selectedType === 'resource'"
              (click)="filterByType('resource')"
              >资源</mat-chip-option
            >
            <mat-chip-option
              [selected]="selectedType === 'template'"
              (click)="filterByType('template')"
              >模板</mat-chip-option
            >
          </mat-chip-listbox>
        </div>
...
export class StoreSearchComponent implements OnInit {
  ...
  navigateToDetail(id: string): void {
    void this.router.navigate(['/store/content', id]);
  }
    ...
    this.results = [
      {
        id: 'c1',
        title: 'Python 游戏开发入门',
        description: '学习使用 Pygame 开发经典小游戏',
        price: 0,
        rating: 4.8,
        contentType: 'course',
        category: '编程开发',
