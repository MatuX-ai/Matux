      ...
      <div class="lab-panel">
        <mat-tab-group>
          <mat-tab label="🔬 物理实验">
            <div class="tab-content">
              ...
              <div class="lab-actions">
                <button mat-raised-button color="primary" (click)="loadLabScene('physics')">
                  力学实验
                </button>
                <button mat-raised-button color="accent" (click)="loadLabScene('optics')">
                  光学实验
                </button>
          ...
          <mat-tab label="🧪 化学实验">
            <div class="tab-content">
              <p>3D 分子结构与化学反应可视化</p>
              <button mat-raised-button color="primary" (click)="loadLabScene('chemistry')">
                进入化学实验室
              </button>
            </div>
          </mat-tab>
          <mat-tab label="🔧 工程实践">
            <div class="tab-content">
              <p>工程设计、3D 打印预览</p>
              <button mat-raised-button color="primary" (click)="loadLabScene('engineering')">
                进入工程实验室
              </button>
            </div>
          </mat-tab>
...
export class VirtualLabComponent {
  loadLabScene(type: string): void {
    console.warn('[VirtualLab] Loading scene:', type);
  }
}
